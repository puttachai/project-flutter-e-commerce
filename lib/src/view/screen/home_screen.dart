...
import 'package:e_commerce_flutter/src/view/screen/ProfileScreen.dart';
...
//   String url =
//       '${MyConstant().domain}/admin_flutter/getProductWhereType_phone.php?isAdd=true&phone_shop=00000'; //&phone_shop=0000000000
//   await Dio().get(url).then((value) {
//     //print('value = $value');
//     var resule = json.decode(value.data);
//     for (var map in resule) {
//       TypeModel1 model = TypeModel1.fromJson(map);
//       //print('NameShop = ${model.typeName}');

//       // ignore: unused_local_variable
//       String? typename = model.typename;
//       if (typename!.isNotEmpty) {
//         print('NameShop = $typename');
//         setState(() {
